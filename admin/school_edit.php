...
<!-- ########## END: HEAD PANEL ########## -->
  ...
  <div class="sl-mainpanel">
    <nav class="breadcrumb sl-breadcrumb">
      ...
      <span class="breadcrumb-item active">Update Schools</span>
    </nav>

    <div class="sl-pagebody"><!-- MAIN CONTENT -->
		<div class="card pd-20 pd-sm-40">
          <h6 class="card-body-title">Schools Update</h6>
          <p class="mg-b-20 mg-sm-b-30">A form for updating Schools</p>
          ...
          <div class="form-layout">
            ...
            <div class="form-layout-footer">
              <button type="submit" class="btn btn-success mg-r-5" name="btn-SchoolUpdate">Update School</button>
