...
<?php 
    ...
    $requisition_list = fetch_all_data_usingPDO($pdo,"select * from requisition_order_list where status = 1");
...
<!-- ########## END: HEAD PANEL ########## -->
  ...
  <div class="sl-mainpanel">
    <nav class="breadcrumb sl-breadcrumb">
      ...
      <span class="breadcrumb-item active">Requisition Confirmed</span>
    </nav>
