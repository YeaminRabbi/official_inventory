  ...
  <div class="sl-mainpanel">
    ...
    <div class="sl-pagebody"><!-- MAIN CONTENT -->
		<div class="card pd-20 pd-sm-40">
          <h6 class="card-body-title">Billing Information</h6>
          <p class="mg-b-20 mg-sm-b-30">A form for Billing Information</p>
            ...
            <div class="row mg-b-25">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" value="<?= $data['name'] ?>" name="requisition_name"  required>
                </div>
              </div><!-- col-4 -->
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" value="<?= $data['contact'] ?>" name="requisition_contact"  required>
                </div>
              </div><!-- col-4 -->
